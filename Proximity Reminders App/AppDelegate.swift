            ...
            if settings.authorizationStatus == .notDetermined {
                ...
                UNUserNotificationCenter.current().requestAuthorization(options: authOptions) { (granted, error) in
                    if granted {
                        ...
                        let alertController = UIAlertController(title: "Ok, we won't ask again.", message: "In order to receive your reminder notifications you will have to enable notifications in your settings. Click the button below to see where it's at.", preferredStyle: .alert)
